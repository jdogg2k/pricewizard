    ...
    return <div><div className='row justify-content-center'>
        ...
        <div className='col-4'>
          ...
          <div className="input-group mb-3 mt-5">
              ...
              <CurrencyInput id="externalconsulting" name="externalconsulting" className="form-control" prefix="$" defaultValue={props.data.current.externalconsulting} onValueChange={(value, name) => setStateData(value, name)} />
            </div>
        ...
        <div className='col-4'>
          ...
          <div className="input-group mb-3 mt-5">
            ...
            <CurrencyInput id="servicevalue" name="servicevalue" className="form-control" prefix="$" defaultValue={props.data.current.servicevalue} onValueChange={(value, name) => setStateData(value, name)} />
          </div>
        ...
        <div className='row justify-content-center'>
          ...
          <div className="input-group mb-3 mt-5">
            ...
            <CurrencyInput id="nonstandard" name="nonstandard" className="form-control" prefix="$" defaultValue={props.data.current.nonstandard} onValueChange={(value, name) => setStateData(value, name)} />
          </div>
          <div className="form-text text-left">
          ...
          <div className="input-group mb-3 mt-5">
            ...
            <CurrencyInput id="discountpremium" name="discountpremium" className="form-control" prefix="$" defaultValue={props.data.current.discountpremium} onValueChange={(value, name) => setStateData(value, name)} />
          </div>
          <div className="form-text text-left">
       ...
       <div className='row justify-content-center'>
        ...
        <div className='col-4'>
            ...
            <div className="input-group mb-3 mt-5">
                ...
                <CurrencyInput id="inflationpremium" name="inflationpremium" className="form-control" prefix="$" defaultValue={props.data.current.inflationpremium} onValueChange={(value, name) => setStateData(value, name)} />
              </div>
              <div className="form-text text-left">
          ...
          <div className="input-group mb-3 mt-5">
            ...
            <CurrencyInput id="curriskpremium" name="curriskpremium" className="form-control" prefix="$" defaultValue={props.data.current.curriskpremium} onValueChange={(value, name) => setStateData(value, name)} />
          </div>
          <div className="form-text">
          ...
          <div className="input-group mb-3 mt-5">
            ...
            <CurrencyInput id="cashpremium" name="cashpremium" className="form-control" prefix="$" defaultValue={props.data.current.cashpremium} onValueChange={(value, name) => setStateData(value, name)} />
          </div>
          <div className="form-text text-left">
          ...
          <div className="input-group mb-3 mt-5">
            ...
            <CurrencyInput id="taxpremium" name="taxpremium" className="form-control" prefix="$" defaultValue={props.data.current.taxpremium} onValueChange={(value, name) => setStateData(value, name)} />
          </div>
          <div className="form-text text-left">
