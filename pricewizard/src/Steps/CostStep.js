      ...
      return <div className='row justify-content-center'>
          ...
          <div className='col-8'>
            ...
            <div className="input-group mb-3 mt-5">
              ...
              <CurrencyInput id="compshrink" name="compshrink" className="form-control" prefix="$" defaultValue={props.data.current.compshrink} onValueChange={(value, name) => setStateData(value, name)} />
            </div>
            ...
            <div className="input-group mb-3 mt-5">
              ...
              <CurrencyInput id="packaging" name="packaging" className="form-control" prefix="$" defaultValue={props.data.current.packaging} onValueChange={(value, name) => setStateData(value, name)} />
            </div>
            ...
            <div className="input-group mb-3 mt-5">
              ...
              <CurrencyInput id="finishedshrink" name="finishedshrink" className="form-control" prefix="$" defaultValue={props.data.current.finishedshrink} onValueChange={(value, name) => setStateData(value, name)} />
            </div>
            <div className="form-text text-left">
            ...
            <div className="input-group mb-3 mt-5">
              ...
              <CurrencyInput id="interplantfreight" name="interplantfreight" className="form-control" prefix="$" defaultValue={props.data.current.interplantfreight} onValueChange={(value, name) => setStateData(value, name)} />
            </div>
            <div className="form-text text-left">
            ...
            <div className="input-group mb-3 mt-5">
              ...
              <CurrencyInput id="manufacturingcost" name="manufacturingcost" className="form-control" prefix="$" defaultValue={props.data.current.manufacturingcost} onValueChange={(value, name) => setStateData(value, name)} />
            </div>
            <div className="form-text text-left">
